...
const SignUpModal: React.FC<SignUpModalProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className={`relative bg-linear-to-br from-cyan-400 to-cyan-500 rounded-3xl shadow-2xl w-full h-auto max-w-83.5 max-h-125 md:max-w-174.5 md:max-h-133 lg:max-w-7xl lg:max-h-152 transform transition-all duration-300 ${
